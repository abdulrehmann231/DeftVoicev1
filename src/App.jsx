          ...
          <div style={{ display: 'flex', gap: '32px' }}>
            {['Portfolio', 'Developers', 'Company'].map(item => (
              <a 
                ...
                style={{
                  color: currentView === 'portfolio' && item === 'Portfolio' ? '#111827' : '#4B5563',
                  fontSize: '0.9rem',
                  fontWeight: currentView === 'portfolio' && item === 'Portfolio' ? 700 : 600,
                  textDecoration: 'none',
                  opacity: currentView === 'portfolio' && item === 'Portfolio' ? 1 : 0.8,
